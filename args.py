...
parser.add_argument('--save_path', type=str, default='D:/project/pycharm professional/time-fre/test')
parser.add_argument('--data_path', type=str,
                    default='D:/project/pycharm professional/time-fre/data/')
...
parser.add_argument('--class_dropout', type=float, default=0.01, help='classfication dropout')
...
parser.add_argument('--num_stage', nargs='+',type=int, default=2, help='num_blocks in each stage')
